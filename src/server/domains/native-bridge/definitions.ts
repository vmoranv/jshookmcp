...
export const nativeBridgeTools: Tool[] = [
  ...
  tool('ghidra_bridge')
    ...
    .enum('action', ['status', 'open_project', 'list_functions', 'decompile_function', 'run_script', 'get_xrefs', 'search_strings'], 'Action to perform')
  ...
  tool('ida_bridge')
    ...
    .enum('action', ['status', 'open_binary', 'list_functions', 'decompile_function', 'run_script', 'get_xrefs', 'get_strings'], 'Action to perform')
