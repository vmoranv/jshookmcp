...
Example:
  human_mouse({ toX: 500, toY: 300, durationMs: 800 })`)
    ...
    .enum('curve', ['ease', 'linear', 'ease-in', 'ease-out'], 'Speed curve (default: ease)', { default: 'ease' })
...
Example:
  human_scroll({ distance: 1000, direction: "down", durationMs: 2000 })`)
    ...
    .enum('direction', ['up', 'down', 'left', 'right'], 'Scroll direction (default: down)', { default: 'down' })
...
Example:
  human_typing({ selector: "#email", text: "user@example.com", wpm: 80 })`)
    ...
    .number('errorRate', 'Probability of typo per character 0-0.2 (default: 0.02)', { default: 0.02 })
    .number('correctDelayMs', 'Delay before correcting a typo in ms (default: 200)', { default: 200 })
    .boolean('clearFirst', 'Clear existing value before typing (default: false)', { default: false })
