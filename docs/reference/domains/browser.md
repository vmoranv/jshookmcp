...
| `page_screenshot`         | Take a screenshot of the page or a specific DOM element. Pass a CSS selector to capture only that element, or omit/use "all" for full page viewport.                                                                              |
...
| `turnstile_solve`         | Solve a Cloudflare Turnstile challenge specifically.                                                                                                                                                                              |
