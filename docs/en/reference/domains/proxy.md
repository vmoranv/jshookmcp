...
| `proxy_add_rule` | Add an interception rule: forward, mock_response, redirect, or block. |
| `proxy_remove_rule` | Remove a single proxy interception rule by endpointId. Returns the removed rule record. |
