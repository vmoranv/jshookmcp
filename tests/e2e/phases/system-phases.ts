...
export const systemPhases: Phase[] = [
  ...
  {
    name: 'Instrumentation (short-name aliases)',
    concurrent: true,
    group: 'compute-browser',
    setup: [],
    tools: ['instrumentation_session', 'instrumentation_operation', 'instrumentation_artifact'],
  },
  {
  ...
  {
    name: 'State Board (short-name alias)',
    concurrent: true,
    group: 'compute-core',
    setup: [],
    tools: ['state_board', 'state_board_io'],
  },
  {
