...
describe('encoding/handlers.impl.core.runtime.shared', () => {
  ...
  describe('DETECT_SOURCE_SET', () => {
    it('contains all expected DetectSource values', () => {
    ...
    it('is typed as ReadonlySet (no add method on type)', () => {
  ...
  describe('ENTROPY_SOURCE_SET', () => {
    it('contains all expected EntropySource values', () => {
  ...
  describe('DECODE_ENCODING_SET', () => {
    it('contains all expected DecodeEncoding values', () => {
  ...
  describe('OUTPUT_FORMAT_SET', () => {
    it('contains all expected OutputFormat values', () => {
  ...
  describe('INPUT_FORMAT_SET', () => {
    it('contains all expected InputFormat values', () => {
  ...
  describe('OUTPUT_ENCODING_SET', () => {
    it('contains all expected OutputEncoding values', () => {
  ...
  describe('MAGIC_SIGNATURES', () => {
    ...
    it('has exactly 6 signatures', () => {
      expect(MAGIC_SIGNATURES.length).toBe(6);
    });

    it('each signature has format string and bytes array', () => {
    ...
    it('all bytes are valid uint8 values (0-255)', () => {
      for (const sig of MAGIC_SIGNATURES) {
  ...
  describe('type contracts (compile-time + structural)', () => {
    ...
    it('ProtobufFieldNode has expected shape', () => {
    ...
    it('ProtobufParseResult has expected shape', () => {
    ...
    it('ProtobufParseResult can include error', () => {
      const result: ProtobufParseResult = {
        fields: [],
        bytesConsumed: 0,
        error: 'parse failed',
    ...
    it('MsgPackDecodeResult has expected shape', () => {
      const result: MsgPackDecodeResult = { value: 'hello', offset: 6 };
      expect(result.value).toBe('hello');
      expect(result.offset).toBe(6);
    });

    it('EntropyAssessment type accepts all valid values', () => {
  ...
  describe('set cross-relationships', () => {
    it('DETECT_SOURCE_SET and ENTROPY_SOURCE_SET share base64, hex, raw, file', () => {
    ...
    it('DECODE_ENCODING_SET includes base64 and hex (shared with source sets)', () => {
      expect(DECODE_ENCODING_SET.has('base64')).toBe(true);
      expect(DECODE_ENCODING_SET.has('hex')).toBe(true);
    });

    it('OUTPUT_ENCODING_SET includes base64 and hex (shared with decode set)', () => {
      expect(OUTPUT_ENCODING_SET.has('base64')).toBe(true);
      expect(OUTPUT_ENCODING_SET.has('hex')).toBe(true);
    });

    it('INPUT_FORMAT_SET and OUTPUT_FORMAT_SET both contain hex', () => {
      expect(INPUT_FORMAT_SET.has('hex')).toBe(true);
      expect(OUTPUT_FORMAT_SET.has('hex')).toBe(true);
    });

    it('INPUT_FORMAT_SET contains json, OUTPUT_FORMAT_SET also contains json', () => {
