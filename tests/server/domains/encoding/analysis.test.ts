...
describe('EncodingHandlersBase (analysis utilities)', () => {
  ...
  describe('detectEncodingSignals', () => {
    ...
    it('returns empty when there are no signals', async () => {
      expect(
  ...
  describe('calculateByteFrequency', () => {
    ...
    it('rounds ratios to 6 decimals', async () => {
  ...
  describe('calculateBlockEntropies', () => {
    ...
    it('returns a single block when buffer is smaller than blockSize', async () => {
      expect(
    ...
    it('returns multiple blocks with independent entropies', async () => {
    ...
    it('handles a final partial block', async () => {
