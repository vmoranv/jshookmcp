...
import { SourcemapGenerator, createSourcemapForTransformation } from '@modules/deobfuscator/SourcemapGenerator';
...
describe('SourcemapGenerator', () => {
  ...
  describe('createSourcemapForTransformation', () => {
    ...
    it('uses custom source name in sourcemap', () => {
      const result = createSourcemapForTransformation('var x = 1;', 'var x = 1;', { source: 'myfile.js' });
